...
$PName = $Description = $Price = $ProductType = $ProductImage = "";
session_start();
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($productNameErr) && empty($DescriptionErr) && empty($PriceErr) && empty($ProductTypeErr)) {
    if (isset($_SESSION["ProductName"]) && isset($_SESSION["Description"]) && isset($_SESSION['price']) && isset($_SESSION['Producttype'])) {
        header("Location: http://localhost:8080/php/folder3/cart.php");
        exit();
    } else {
        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <form id="product-form" action="index.php" method="POST" enctype="multipart/form-data">
